...
const BLOG = {
  AUTHOR: 'haixin', // 作者
  BIO: '要是墓前能留下见地, 记着爱己', // 作者简介
  LINK: 'https://www.haixin.io', // 网站地址
  KEYWORDS: 'haixin,blog', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'b04b5279937a465581759cbd46a63afd', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  FONT_AWESOME_PATH:
    'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css', // 图标库CDN ，国内推荐BootCDN，国外推荐 CloudFlare https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css
  ...
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/haixin1225',
  CONTACT_TELEGRAM: '',
